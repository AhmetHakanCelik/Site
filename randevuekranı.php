...
<li><a href="randevudüzenle.php">Randevu Düzenleme</a></li>
      ...
      <div class="row">
      <div class="col-md-3">
      <h3 class="text-left">RANDEVU  AL</h3><br>
        <form action="ekle.php" method="POST">
          <label for="Adı">Adınız</label>
        <input type="text" name="Ad" class="form-control" style="border-radius:10px"><br>
        <label for="Soyadı">Soyadınız</label>
        <input type="text" name="Soyad" class="form-control" style="border-radius:10px"><br>
   
        <label for="doktor">Diş Hekimi</label>
        <select name="doktor" class="col-md-12 mx-auto"   style="border-radius:10px " >
        ...
        <input type="text" name="Tarih" class="form-control" placeholder="GG.AA.YY" style="border-radius:10px"><br>
        <label for="Saat">Randevu Saati</label>
        <input type="text" name="Saat" class="form-control" placeholder="SS:DD" style="border-radius:10px"><br>
        <label for="Klinik">Klinik</label>
        <input type="text" name="Klinik" class="form-control" style="border-radius:10px"><br>
